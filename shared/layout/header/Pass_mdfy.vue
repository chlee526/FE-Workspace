<template>
    <div style="position: relative">
        <button ref="userLabel" class="user" :class="{ 'is-active': passActive }" @click="passActive = !passActive">
            {{ getUserName }}
        </button>
...
export default {
    ...
    computed: {
        ...
        getUserName() {
            ...
            if (result.length && this.userDatas.id && !this.getUseageLNB) nameIdUseChk = true;
