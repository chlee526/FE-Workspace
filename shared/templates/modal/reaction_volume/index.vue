                                ...
                                <div class="ui_box is-3dp">
                                    <div class="header">
                                        <div class="wrap">
                                            ...
                                            <div class="rc_wrap">
                                                <a href="#" title="Excel 다운로드" class="ui_btn is-icon-only is-small"><span class="icon">&#xe005;</span></a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="wrap">
                            <div class="ui_col">
                                <div class="ui_box is-3dp">
                                    ...
                                    <div class="content" style="height: 1000px">asdasd</div>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    name: 'tmpl-modal-reaction-volume',
