...
module.exports = defineConfig({
    ...
    // publicPath: process.env.NODE_ENV === 'production' ? process.env.APP_VUE_BASE_URL : '/',
    ...
    css: {
        loaderOptions: {
            sass: {
                additionalData: `
                    @import "@shared/styles/util/_mixins.scss";
                    $use_lnb: "${process.env.VUE_APP_USEAGE_LNB}";
                `,
            },
        },
    },
    ...
    chainWebpack: (config) => {
        ...
        //     const filesToExclude = ['**/mockServiceWorker.js', '**/tmp_excel.xlsx'];
        ...
        if (process.env.NODE_ENV === 'production' || (process.env.NODE_ENV === 'development' && process.env.VUE_APP_USEAGE_MSW !== 'true')) {
    ...
    devServer: {
        // allowedHosts: 'all',
        // host: 'fe.workspace.demo.devel.com',
        // port: 8765,
        // client: {
        //     overlay: false,
        // },
